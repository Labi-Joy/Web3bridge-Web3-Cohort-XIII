...
async function main() {
  ...
  console.log("Round:", await lottery.round(), "\n");
  ...
  for (let i = 0; i < 10; i++) {
    ...
    console.log(`   Entered! Players: ${playerCount}/10, Prize Pool: ${ethers.formatEther(prizePool)} ETH`);
  ...
  console.log("Current Round:", round1);
  console.log("Players in new round:", await lottery.getPlayerCount());
  ...
  const secondRoundBalances: { [key: string]: bigint } = {};
  ...
  for (let i = 0; i < 10; i++) {
    ...
    console.log(`   Entered! Players: ${playerCount}/10`);
  ...
  console.log("Current Round:", round2);
  console.log("Players in new round:", await lottery.getPlayerCount());
  ...
  console.log("Final Round:", await lottery.round());
